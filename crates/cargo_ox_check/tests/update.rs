...
use cargo_ox_check::decision::Decision;
use cargo_ox_check::plan::Target;
use cargo_ox_check::run::{RunOutcome, run_update};
...
fn empty_region_is_treated_as_opt_out() {
    use cargo_ox_check::emit::shared_configs::RUSTFMT_REGION_ID;
    use cargo_ox_check::region::{CommentSyntax, upsert_region};
