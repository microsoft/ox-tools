...
flowchart LR
    ...
    impact_setup[".github/actions/<br/>ox-check-setup"]:::action
    fast_setup[".github/actions/<br/>ox-check-setup"]:::action
    test_setup[".github/actions/<br/>ox-check-setup"]:::action
    runtime_setup[".github/actions/<br/>ox-check-setup"]:::action
    mutants_setup[".github/actions/<br/>ox-check-setup"]:::action
    fast_act[".github/actions/<br/>ox-check-pr-fast"]:::action
    test_act[".github/actions/<br/>ox-check-pr-test"]:::action
    runtime_act[".github/actions/<br/>ox-check-pr-runtime-analysis"]:::action
    mutants_act[".github/actions/<br/>ox-check-pr-mutants"]:::action
    codecov_act["codecov/codecov-action@v5"]:::external
    impact_just["cargo delta"]:::recipe
    fast_just["just ox-check-pr-fast"]:::recipe
    fast_setup_just["just ox-check-setup"]:::recipe
    impact_setup_just["just ox-check-setup"]:::recipe
    test_just["just ox-check-pr-test"]:::recipe
    test_setup_just["just ox-check-setup"]:::recipe
    runtime_just["just ox-check-pr-runtime-analysis"]:::recipe
    runtime_setup_just["just ox-check-setup"]:::recipe
    mutants_just["just ox-check-pr-mutants"]:::recipe
    mutants_setup_just["just ox-check-setup"]:::recipe
...
flowchart LR
    ...
    stest_setup[".github/actions/<br/>ox-check-setup"]:::action
    sadv_setup[".github/actions/<br/>ox-check-setup"]:::action
    sexh_setup[".github/actions/<br/>ox-check-setup"]:::action
    ...
    stest_setup_just["just ox-check-setup"]:::recipe
    sadv_just["just ox-check-scheduled-advisories"]:::recipe
    sadv_setup_just["just ox-check-setup"]:::recipe
    sexh_just["just ox-check-scheduled-exhaustive"]:::recipe
    sexh_setup_just["just ox-check-setup"]:::recipe
...
│   ├── ox-check-pr-runtime-analysis/action.yml      owned
...
```yaml
# .github/workflows/ox-check-pr-impl.yml   (owned by cargo-ox-check-update)
on:
  workflow_call:
    inputs:
...
jobs:
  ...
  # cargo-mutants, and the ox-check-mutants-diff recipe self-skips on
...
| `ox-check-pr-test`, `ox-check-pr-runtime-analysis`, `ox-check-scheduled-*` | —                                                                       |
