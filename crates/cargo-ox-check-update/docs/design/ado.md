...
flowchart LR
    ...
    impact_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    fast_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    test_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    runtime_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    mutants_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    fast_step[".pipelines/ox-check/<br/>steps/pr-fast.yml"]:::step
    test_step[".pipelines/ox-check/<br/>steps/pr-test.yml"]:::step
    runtime_step[".pipelines/ox-check/<br/>steps/pr-runtime-analysis.yml"]:::step
    mutants_step[".pipelines/ox-check/<br/>steps/pr-mutants.yml"]:::step
...
flowchart LR
    ...
    stest_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    sadv_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
    sexh_setup[".pipelines/ox-check/<br/>steps/setup.yml"]:::step
...
```yaml
# .pipelines/ox-check/pr.yml   (owned by cargo-ox-check-update)
parameters:
  - name: linuxPool
    type: object
...
```yaml
# .pipelines/ox-check/steps/pr-fast.yml  (owned by cargo-ox-check-update)
parameters:
- name: prTitle
  type: string
