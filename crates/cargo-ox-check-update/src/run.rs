...
pub fn run_update(args: &Cli, start_dir: &Path) -> Result<RunOutcome, AppError> {
    ...
    // One-time legacy migration: an earlier version of cargo-ox-check-update
