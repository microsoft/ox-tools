...
///
/// Earlier versions of cargo-ox-check-update used `JUSTFILE_PATH = "justfile"`
...
mod tests {
    ...
    fn groups_just_template_includes_all_groups_and_pr_slow_sub_recipes() {
        ...
        for needle in ["ox-check-pr-slow1:", "ox-check-pr-slow2:", "ox-check-pr-slow3:"] {
        ...
        assert!(GROUPS_JUST.contains("ox-check-pr-slow: ox-check-pr-test ox-check-pr-runtime-analysis ox-check-pr-mutants"));
    }
