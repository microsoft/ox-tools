...
//! In CI we enforce installation via the `ox-check-tools-install` recipe;
//! locally the test suite degrades gracefully.
//!
//! See `crates/cargo-ox-check-update/docs/verification.md` for the
...
use cargo_ox_check_update::run::run_update;
