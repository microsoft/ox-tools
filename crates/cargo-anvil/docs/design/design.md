...
- [container-config.md](./container-config.md) — the declarative contract a repository uses to
  extend the container image and declare mounts, caches, and repository-owned commands.
