...
//!
//! Each is a TOML file with a single `anvil-*` region near the end.
...
///
/// Defaults aligned with the `anvil-spellcheck` recipe's behavior:
...
mod tests {
    ...
    fn rustfmt_body_sets_edition_and_width() {
        ...
        // comment code formatting. anvil-fmt invokes nightly
    ...
    fn spellcheck_body_configures_hunspell_with_extra_dictionary() {
        ...
        // Generated by anvil-spellcheck from .spelling — the recipe
