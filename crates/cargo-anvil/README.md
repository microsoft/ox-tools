...
A repository’s `Justfile` imports `.anvil/anvil.just`; each recipe invokes
ordinary Rust and Cargo tools.
...
shared configuration files. Checksums in `.anvil/manifest.toml` record the generated
...
This crate was developed as part of <a href="../..">The Oxidizer Project</a>. Browse this crate's <a href="https://github.com/microsoft/ox-tools/tree/main/crates/cargo-anvil">source code</a>.
 ...
 [__cargo_doc2readme_dependencies_info]: ggGmYW0CYXZlMC43LjNhdIQblRYhli3L8qob_NSi_WYo69wbWnMVqZw3jJwb3u56HnT6RDphYvRhcoQb9TvOm_F5xcMbAZInGp9XFdQbGUZy0iBEKp0bKKDWWuDHYdlhZIGDa2NhcmdvLWFudmlsZjAuMTIuMGtjYXJnb19hbnZpbA
